...
def main_voc():
    ...
    train_dataset = Voc2007Classification("data/VOC2007",'trainval', inp_name=args.embedding)
    val_dataset = Voc2007Classification("data/VOC2007", 'test', inp_name=args.embedding)
    num_classes = 20
